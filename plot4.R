...
#first plot
plot(x = df_date_sub$DateTime , y = df_date_sub$Global_active_power, ylab = "Global active power (kilowatts)" ,xlab = "", type = "S")

#second plot
plot(x = df_date_sub$DateTime, y = df_date_sub$Voltage, ylab = "Voltage", xlab = "datetime", type = "S")


# third plot
plot(x = df_date_sub$DateTime , y = df_date_sub$Sub_metering_1, ylab = "Energy sub metering" ,xlab = "", type = "S")
lines(x = df_date_sub$DateTime , y = df_date_sub$Sub_metering_2, col = "red")
lines(x = df_date_sub$DateTime , y = df_date_sub$Sub_metering_3, col = "blue")
my_legend <- c("Sub_metering_1","Sub_metering_2","Sub_metering_3")
legend("topright", my_legend, lty = 1, col = c("black","red","blue"),bty = "n" )

# fourth plot
plot(x = df_date_sub$DateTime, y = df_date_sub$Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime", type = "S")
